...
public class ErosiPanel extends JPanel {
	...
	private JLabel datuPrezioTotala;
	...
	public ErosiPanel(NagusiaPanel nagusiaPanel) {
		...
		JLabel prezioaGuztiraLabel;
		prezioaGuztiraLabel = new JLabel();
		prezioaGuztiraLabel.setText("Prezioa Guztira:");
		...
		katalogoaOrriNagusiraButton.setText("Katalogoko Orri Nagusira Itzuli");
			...
			groupLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
						.addComponent(scrollPane, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 490, Short.MAX_VALUE)
						.addGroup(groupLayout.createSequentialGroup()
						...
						.addComponent(separator, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 490, Short.MAX_VALUE)
		...
		comboBox = new JComboBox(new String[]{"Araba","Alacant","Albacete","Almeria","Asturias","Avila","Badajoz","Balear Uharteak","Bartzelona","Bizkaia","Burgos","Caceres","Cadiz","Castello","Ciudad Real","Coruña","Cuenca","Errioxa","Gipuzkoa","Girona","Granada","Guadalajara","Huelva","Huesca","Jaen","Kantabria","Kordoba","Leon","Lleida","Lugo","Madrilgo Erkidegoa","Malaga","Murtziako Erkidegoa","Nafarroa","Ourense","Palentzia","Las Palmas","Pontevedra","Salamanca","Segovia","Sevilla","Soria","Tarragona","Tenerifeko Santa Kruz","Teruel","Toledo","Valentzia","Valladolid","Zamora","Zaragoza"});
			...
			groupLayout_1.createParallelGroup(GroupLayout.Alignment.LEADING)
				.addGroup(groupLayout_1.createSequentialGroup()
					...
					.addGroup(groupLayout_1.createParallelGroup(GroupLayout.Alignment.LEADING)
						.addComponent(helbideTextField, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 490, Short.MAX_VALUE)
						.addGroup(GroupLayout.Alignment.TRAILING, groupLayout_1.createSequentialGroup()
							...
							.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
							.addGroup(groupLayout_1.createParallelGroup(GroupLayout.Alignment.LEADING)
								.addComponent(izenaTextField, GroupLayout.DEFAULT_SIZE, 423, Short.MAX_VALUE)
								.addComponent(abizenakTextField, GroupLayout.DEFAULT_SIZE, 423, Short.MAX_VALUE)))
						.addGroup(groupLayout_1.createSequentialGroup()
						...
						.addGroup(GroupLayout.Alignment.TRAILING, groupLayout_1.createSequentialGroup()
							...
							.addGroup(groupLayout_1.createParallelGroup(GroupLayout.Alignment.LEADING)
								.addGroup(groupLayout_1.createSequentialGroup()
									...
									.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED))
								.addComponent(hiriaTextField, GroupLayout.DEFAULT_SIZE, 388, Short.MAX_VALUE)))
						.addGroup(GroupLayout.Alignment.TRAILING, groupLayout_1.createSequentialGroup()
							.addComponent(atzeraButton)
							.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
							.addComponent(jarraituButton_1))
						.addComponent(separator_1, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 490, Short.MAX_VALUE)
						.addGroup(groupLayout_1.createSequentialGroup()
			...
			groupLayout_2.createParallelGroup(GroupLayout.Alignment.LEADING)
				.addGroup(groupLayout_2.createSequentialGroup()
					...
					.addGroup(groupLayout_2.createParallelGroup(GroupLayout.Alignment.LEADING)
						...
						.addComponent(txartelInfo, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 490, Short.MAX_VALUE)
						...
						.addComponent(separator_2, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 490, Short.MAX_VALUE)
		...
		erosketaBukatuButton.addActionListener(new ActionListener() {
			public void actionPerformed(final ActionEvent e) {
				//Erosketa-saskia hustu
				SaskiratutakoZapatak.getInstance().saskiaHustu();
				//Datuak hustu
				datuakHustu();
				jabea.revalidate();
				//Karta Aldatu
			...
			groupLayout_4.createParallelGroup(GroupLayout.Alignment.TRAILING)
				.addGroup(groupLayout_4.createSequentialGroup()
					...
					.addGroup(groupLayout_4.createParallelGroup(GroupLayout.Alignment.LEADING)
						.addComponent(fakturaPanel, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 490, Short.MAX_VALUE)
						.addComponent(separator_3, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 490, Short.MAX_VALUE)
		...
		groupLayout_4.setVerticalGroup(
			groupLayout_4.createParallelGroup(GroupLayout.Alignment.LEADING)
				.addGroup(groupLayout_4.createSequentialGroup()
					...
					.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
					.addComponent(fakturaPanel, GroupLayout.DEFAULT_SIZE, 344, Short.MAX_VALUE)
					.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
			...
			groupLayout_5.createParallelGroup(GroupLayout.Alignment.TRAILING)
				.addGroup(groupLayout_5.createSequentialGroup()
					...
					.addGroup(groupLayout_5.createParallelGroup(GroupLayout.Alignment.LEADING)
						.addComponent(kodeBidalketa, GroupLayout.DEFAULT_SIZE, 490, Short.MAX_VALUE)
						.addComponent(separator_4, GroupLayout.DEFAULT_SIZE, 490, Short.MAX_VALUE)
			...
			groupLayout_7.createParallelGroup(GroupLayout.Alignment.LEADING)
				.addGroup(groupLayout_7.createSequentialGroup()
					...
					.addGroup(groupLayout_7.createParallelGroup(GroupLayout.Alignment.LEADING)
						...
						.addComponent(separator_5, GroupLayout.DEFAULT_SIZE, 490, Short.MAX_VALUE)
	...
	public void prezioTotalaEguneratu(){
		float prezioTotala = 0.0f;
		Component[] cp = scrollEdukiPanel.getComponents();
		for(int i=0; i<cp.length;i++){
			ErosketaSaskiaItem ei = (ErosketaSaskiaItem)cp[i];
			prezioTotala = prezioTotala + ei.prezioa;
		}
		datuPrezioTotala.setText(twoDForm.format(prezioTotala) + " €");
	}
	...
	public void datuakHustu(){
		...
		iraungDataTextField.setText("");
		txartelZenbTextField.setText("");
		jabeIzenAbTextField.setText("");
		hiriaTextField.setText("");
		pkTextField.setText("");
		helbideTextField.setText("");
