...
public class SaskiratutakoZapatak {
	...
	private SaskiratutakoZapatak(){
		...
		saskikoZapatak.addElement(new Zapata (2,"Ezker",42f,"Emakumezkoa","Zilarra/Urdina/Arrosa","Larrua","Korritzeko zapatak","Saucony",98.95f,false,"ez",0.0f,false,60,true,"2.jpg" ));
